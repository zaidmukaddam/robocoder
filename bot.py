...
class RoboCoder(commands.Bot):
    def __init__(self):
        ...
        self.support_server_link = "https://discord.gg/NeZvXk5wh5"
    ...
    async def on_ready(self):
        ...
        if self.config.status_hook:
            ...
            await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name="r!help amd r!invite"))
